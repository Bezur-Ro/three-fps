...
app.get('/game/three/pointerlockcontrols.js', (req, res) => {
  res.sendFile(__dirname + "/public/three/pointerlockcontrols.js")
});

app.get('/game/three/three.module.min.js', (req, res) => {
  res.sendFile(__dirname + "/public/three/three.module.js")
});
